	...
	public static ByteArrayInputStream gerar(Processo processo, Fornecedor fornecedor) {
		...
		try {
			...
			Paragraph conteudo = new Paragraph(
					"       Notificamos Vossa Senhoria, para que se manifeste, conforme a determinação do Despacho Administrativo (anexo), no prazo de 10 (dez) dias a contar do recebimento desta.",
					intFont);
