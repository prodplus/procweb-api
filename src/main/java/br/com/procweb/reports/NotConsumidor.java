		...
		try {
			...
			Paragraph conteudo = new Paragraph(
					"       Notificamos Vossa Senhoria para comparecer neste Órgão no"
							+ " prazo de 48 horas, a contar do recebimento desta, no horário "
							+ "de atendimento (das 13:30h às 17:00h), para manifestar-se a "
			...
			Paragraph certidaoCont = new Paragraph("Certifico que expedi, via AR, ao consumidor.",
					intFont);
